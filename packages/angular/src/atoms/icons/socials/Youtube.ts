/*
  ...
  The file source is in `packages/core/atoms/icons/socials/Youtube.lite.tsx`
 */
...
@Component({
  ...
  template: `
    <svg
      ...
      [attr.data-testid]="dataTestId ?? 'youtube'"
    >
      ...
      <defs>
        <clipPath id="clip0_4049_2553"><rect width="24" height="24" fill="white"></rect></clipPath>
      </defs>
    </svg>
  `,
  styles: [
