...
export const iconList = {
  base: [
    ...
    { Component: icons.WorkIcon, name: 'Work', selector: 'gi-work-icon' },
  ],
  navigation: [
    ...
    { Component: icons.ArrowBackwardIcon, name: 'ArrowBackward', selector: 'gi-arrow-backward-icon' },
    ...
    { Component: icons.ArrowLeftIcon, name: 'ArrowLeft', selector: 'gi-arrow-left-icon' },
    { Component: icons.ArrowRightIcon, name: 'ArrowRight', selector: 'gi-arrow-right-icon' },
    { Component: icons.ArrowDropDownIcon, name: 'ArrowDropDown', selector: 'gi-arrow-drop-down-icon' },
    { Component: icons.ArrowDropUpIcon, name: 'ArrowDropUp', selector: 'gi-arrow-drop-up-icon' },
