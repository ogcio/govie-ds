...
import { Variant, Appearance, ButtonSize } from '../Button.lite';
...
export const buttonMeta = {
  ...
  argTypes: {
    ...
    variant: enumType(Variant, { description: 'Visual style variant of the button.', defaultValue: Variant.PRIMARY }),
    appearance: enumType(Appearance, {
      description: 'Colour appearance of the button.',
      defaultValue: Appearance.DEFAULT,
    }),
    size: enumType(ButtonSize, { description: 'Size of the button.', defaultValue: ButtonSize.MD }),
    disabled: {
      control: false,
    ...
    type: {
      control: false,
      description:
        'HTML button type attribute. Defaults to `"button"` to prevent accidental form submission. Accepts `"button"`, `"submit"`, or `"reset"`.',
    ...
    value: {
      control: false,
      description:
        'Value submitted with the form when the button is of type `"submit"`. Maps to the HTML `value` attribute.',
      table: { type: { summary: 'string' } },
    },
    tabIndex: {
      control: false,
    ...
    ariaLabel: {
      control: false,
      description:
        'Accessible label for the button. Use when the button has no visible text or when the visible text is insufficient to describe the action. Maps to `aria-label`.',
      table: { type: { summary: 'string' } },
    },
    ariaLabelledBy: {
      control: false,
    ...
    ariaPressed: {
      control: false,
      description:
        'Indicates whether the button is currently pressed. Use for toggle buttons. Accepts `true`, `false`, or `"mixed"`. Maps to `aria-pressed`.',
      table: { type: { summary: 'boolean | "mixed"' } },
    },
    ariaExpanded: {
      control: false,
      description:
        'Indicates whether a controlled element (e.g. a menu or disclosure) is expanded or collapsed. Maps to `aria-expanded`.',
      table: { type: { summary: 'boolean' } },
    },
    ariaControls: {
      control: false,
      description:
        'Points to the id of the element the button controls (e.g. a panel, menu, or dialog). Maps to `aria-controls`.',
      table: { type: { summary: 'string' } },
    },
    ariaHasPopup: {
      control: false,
      description:
        'Indicates that the button can open a popup element such as a menu, listbox, or dialog. Maps to `aria-haspopup`.',
      table: { type: { summary: 'boolean | "menu" | "listbox" | "dialog" | "grid" | "tree"' } },
    },
    ariaBusy: {
      control: false,
