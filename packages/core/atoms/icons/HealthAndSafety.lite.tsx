...
useMetadata({ angular: { selector: 'gi-health-and-safety-icon' } });

export default function HealthAndSafety(props: IconProps) {
  return (
    <svg
      ...
      data-testid={props.dataTestId ?? 'health-and-safety'}
