...
describe('checkboxes', () => {
  ...
  it('should update aria-checked attribute correctly', () => {
    ...
    const noneCheckbox = screen.getByText('None').previousElementSibling as HTMLInputElement;
  
    const checkbox1 = screen.getByText('Checkbox 1').previousElementSibling as HTMLInputElement;
    const checkbox2 = screen.getByText('Checkbox 2').previousElementSibling as HTMLInputElement;
