  ...
  <div class="md:gi-w-2/3 gi-w-full">
   <div class="gi-flex gi-w-full gi-justify-start gi-items-start gi-flex-col gi-gap-3 gi-flex-nowrap" role="region" aria-label="Items Stacked" data-testid="govie-stack" style="height: 100%;">
      <div class="gi-flex gi-w-full gi-justify-start gi-items-start gi-flex-col md:gi-flex-row gi-gap-3 gi-flex-nowrap" role="region" aria-label="Items Stacked" data-testid="govie-stack" style="height: 100%;">
         <div role="group" class="gi-input-text-container" aria-labelledby="text-1-label">
            ...
            <div class="gi-input-text-container"><input id="text-1" type="text" data-testid="govie-stack-item-0" aria-invalid="false" class="gi-input-text gi-border-gray-950"></div>
         </div>
         <div role="group" class="gi-input-text-container" aria-labelledby="text-2-label">
            ...
            <div class="gi-input-text-container"><input id="text-2" type="text" data-testid="govie-stack-item-1" aria-invalid="false" class="gi-input-text gi-border-gray-950"></div>
         </div>
      </div>
      <div class="gi-flex gi-w-full gi-justify-start gi-items-start gi-flex-col md:gi-flex-row gi-gap-3 gi-flex-nowrap" role="region" aria-label="Items Stacked" data-testid="govie-stack" style="height: 100%;">
         <div role="group" class="gi-input-text-container" aria-labelledby="text-4-label">
            ...
            <div class="gi-input-text-container"><input id="text-4" type="text" data-testid="govie-stack-item-0" aria-invalid="false" class="gi-input-text gi-border-gray-950" maxlength="5"></div>
         </div>
      </div>
      <div class="gi-flex gi-w-full gi-justify-start gi-items-start gi-flex-col md:gi-flex-row gi-gap-3 gi-flex-nowrap" role="region" aria-label="Items Stacked" data-testid="govie-stack" style="height: 100%;">
         <div role="group" class="gi-input-text-container" aria-labelledby="text-input-id-label">
            ...
            <div class="gi-input-text-container"><input id="text-input-id" type="date" data-testid="govie-stack-item-0" aria-invalid="false" class="gi-input-text gi-border-gray-950"></div>
         </div>
         <div role="group" class="gi-input-text-container" aria-labelledby="text-input-id-label">
            ...
            <div class="gi-input-text-container">
               <div class="gi-input-text-prefix">cm</div>
               <input id="text-input-id" type="text" data-testid="govie-stack-item-1" aria-invalid="false" class="gi-input-text gi-border-gray-950">
            </div>
         </div>
         <div class="gi-w-full sm:gi-w-[80px] gi-flex-none" data-testid="govie-stack-item-2">
            <div role="group" class="gi-input-text-container" aria-labelledby="text-4-label">
               ...
               <div class="gi-input-text-container"><input id="text-4" type="text" data-testid="textbox" aria-invalid="false" class="gi-input-text gi-border-gray-950" maxlength="3"></div>
            </div>
         </div>
      </div>
      <div role="group" class="gi-input-text-container gi-error-state" aria-labelledby="text-4-label">
         ...
         <div class="gi-input-text-container"><input id="text-4" type="text" data-testid="govie-stack-item-3" aria-invalid="true" class="gi-input-text gi-border-red-600" pattern="d*" maxlength="10"></div>
      </div>
   </div>
</div>
`,
