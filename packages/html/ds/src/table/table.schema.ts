...
export const tableSchema = zod.object({
  captionText: zod
    .string({
      description: 'Text for the table caption, providing a brief description of the table contents.',
    })
    .optional(),
  headers: zod
    .array(zod.string(), {
      description: 'An array of strings representing column headers for the table.',
    })
    .optional(),
  rows: zod
    .array(
