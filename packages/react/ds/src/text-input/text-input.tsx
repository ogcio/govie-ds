  ...
  (
    ...
    return (
      <div className="gi-flex gi-items-center">
        ...
        />
        {suffix && (
          <div className="xs:gi-text-md gi-text-sm gi-leading-5 xs:!gi-leading-5gi-bg-gray-50 gi-inline-block gi-flex-[0_0_auto] gi-text-center gi-whitespace-nowrap gi-cursor-default gi-px-2 gi-py-2 gi-border-r-sm gi-border-t-sm gi-border-b-sm gi-border-solid gi-border-gray-950 gi-min-w-10 gi-h-10">
            {suffix}
          </div>
        )}
      </div>
