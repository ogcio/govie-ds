...
export interface PersonCancelProps extends SVGProps<SVGSVGElement> {
  size?: string | number;
}

export const PersonCancel = forwardRef<SVGSVGElement, PersonCancelProps>(
  ({ size = 24, ...props }, ref) => (
    <svg
      ref={ref}
      width={size}
...
PersonCancel.displayName = 'PersonCancel';
