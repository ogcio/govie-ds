...
import {
  ...
  ControlledOpen as openStory,
} from '@/atoms/storybook/SideNavGroup.meta';
...
const meta = {
  ...
  argTypes: {
    ...sideNavGroupMeta.argTypes,
    actions: {
      ...sideNavGroupMeta.argTypes.actions,
      table: { type: { summary: 'React.ReactNode' } },
    },
    label: {
      ...sideNavGroupMeta.argTypes.label,
      table: { type: { summary: 'React.ReactNode' } },
    },
  },
  parameters: {
