...
const meta = {
  title: 'Layout/Container/Deprecated',
  tags: ['deprecated'],
  parameters: {
    docs: {
      description: {
        component:
          '**Deprecated.** This story documents the legacy `Container` from `packages/react/src/container`. Prefer **Layout/Container** (Mitosis-generated atom) for new work.',
      },
    },
  },
  component: Container,
