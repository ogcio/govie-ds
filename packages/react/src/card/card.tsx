...
export const Card = (props: CardProps) => {
  ...
  if (isLegacy) {
    console.warn('[Card] Using legacy props. Please migrate to the new composable API.');
  ...
  const cleanRest = Object.fromEntries(Object.entries(rest).filter(([key]) => !deprecatedSet.has(key))) as typeof rest;
