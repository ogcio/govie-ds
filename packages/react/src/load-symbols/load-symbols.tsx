 ...
 * @deprecated It is now safe to remove this component. Fetching and loading the material fonts is now no longer necessary as all icons are now integrated within the package.
 */
