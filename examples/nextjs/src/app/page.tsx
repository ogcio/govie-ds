...
const NativeFormExample = () => {
  ...
  const [nativeCharCount, setNativeCharCount] = useState(0);
  const maxNativeChars = 150;
        ...
        <div className="space-y-4">
          ...
          <FormField>
            ...
            <TextArea
              ...
              name="message"
              rows={4}
              maxLength={maxNativeChars}
              placeholder="Enter your message..."
              onChange={(e) => setNativeCharCount(e.target.value.length)}
            />
            <HintText
              text={`You have ${maxNativeChars - nativeCharCount} characters remaining`}
            />
          </FormField>
...
const ReactHookFormRegisterExample = () => {
          ...
          <div className="space-y-4">
            ...
            <FormField>
              ...
              <TextArea
                ...
                cols={100}
                rows={4}
                maxLength={maxBasicChars}
                {...register('textArea')}
              />
              <HintText
                text={`You have ${maxBasicChars - (textAreaValue?.length || 0)} characters remaining`}
              />
            </FormField>
...
const ReactHookFormControllerExample = () => {
...
const StandaloneTextAreaExample = () => {
  ...
  return (
    <FormField>
      ...
      />
      <HintText text={`You have ${maxChars - charCount} characters remaining`} />
    </FormField>
  );
};
        ...
        <Tabs ariaLabelledBy="next-tabs-example" id="tab-example" size="md">
          ...
          <TabPanel value="forms">
            <div className="space-y-8">
              ...
              <NativeFormExample />
              <ReactHookFormRegisterExample />
              <ReactHookFormControllerExample />
