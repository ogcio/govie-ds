...
const standardComponents: MDXComponents = {
  h1: ({ children }) => <Heading as={HeadingAs.h1}>{children}</Heading>,
  h2: ({ children }) => <Heading as={HeadingAs.h2}>{children}</Heading>,
  h3: ({ children }) => <Heading as={HeadingAs.h3}>{children}</Heading>,
  h4: ({ children }) => <Heading as={HeadingAs.h4}>{children}</Heading>,
  h5: ({ children }) => <Heading as={HeadingAs.h5}>{children}</Heading>,
  h6: ({ children }) => <Heading as={HeadingAs.h6}>{children}</Heading>,
