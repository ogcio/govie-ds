...
<ComponentContainer fullWidth>
  <Header
    ...
    items={[{ label: 'Departments', itemType: 'link', details: { href: '#' } }, { label: 'Services', itemType: 'link', details: { href: '#' } }, { itemType: 'divider' }, { label: 'Search', icon: 'search', itemType: 'slot', details: { component: <HeaderSearch />, slotAppearance: 'dropdown' } }, { label: 'Home', icon: 'home', itemType: 'link', details: { href: '/item1' } }]}
