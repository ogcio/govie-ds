    ...
    <div class="gi-card-content gi-card-content-inset">
      <div class="gi-card-header">
        <div class="gi-card-heading">
          <h5 class="gi-heading-xs !gi-my-0 !gi-mb-2">Card Title</h5>
          <h6 class="gi-heading-2xs gi-text-gray-500 !gi-font-normal !gi-my-0">
            Subheading
          </h6>
        </div>
    ...
    <div class="gi-card gi-card-horizontal">
      ...
      <div class="gi-card-content gi-card-content-inset">
        <div class="gi-card-header">
          <div class="gi-card-heading">
            <h5 class="gi-heading-xs !gi-my-0 !gi-mb-2">Card Title</h5>
            <p class="gi-text-sm gi-text-gray-500 !gi-font-normal !gi-my-0">Subheading</p>
          </div>
          <div class="gi-card-tag">
            <strong class="gi-tag gi-tag-info">New</strong>
          </div>
