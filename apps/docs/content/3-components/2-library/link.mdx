...
libraries:
  - platform: 'figma'
    link: 'https://www.figma.com/design/ZEqfpXhocdZs1K5YfsE5ws/Design-system?node-id=1454-9194&p=f&t=Re0xIRAmWNDNItHY-0'
    status: 'beta'
  - platform: 'global'
...
<ComponentContainer>
  <Link asChild><NextLink href="/components">Next Link</NextLink></Link>
</ComponentContainer>
