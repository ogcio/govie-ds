...
<ComponentContainer>
  ...
  >
    <TextInputWithResetSample data-testid="text-reset-id" id="text-reset-id" />
  </FormField>
</ComponentContainer>
...
The `InputTextWithReset` component provides an enhanced user experience by allowing users to quickly clear the input field. This is particularly useful in cases where users frequently modify or re-enter information.
