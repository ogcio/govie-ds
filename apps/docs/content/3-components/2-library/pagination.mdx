...
<Tabs id="tab1">
  ...
  <div
   ...
   >
      <span data-testid="govie-icon" role="presentation" class="material-symbols-outlined gi-block gi-text-[24px]">arrow_back</span> <span class='sm:gi-block gi-hidden'>Previous</span>
   </a>
   ...
   >
      <span class='sm:gi-block gi-hidden'>Next</span> <span data-testid="govie-icon" role="presentation" class="material-symbols-outlined gi-block gi-text-[24px]">arrow_forward</span>
   </a>
   </div>
  ```
  </TabPanel>
