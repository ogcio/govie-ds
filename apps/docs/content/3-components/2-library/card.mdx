...
libraries:
  ...
  - platform: 'global'
    ...
    status: 'stable'
  - platform: 'react'
    link: '?path=/docs/components-card-card--docs'
    status: 'stable'
component:
  id: 'card'
  properties:
    - name: CardProps
      fields:
        ...
        - name: 'children'
          ...
          description: 'Composable structure using CardMedia and CardContainer. Inside CardContainer, valid children include: CardHeader, CardBody, CardFooter.'
          required: true
---
...
<ComponentContainer>
  <Card type="vertical" inset="body">
    ...
    <CardContainer inset="body">
      ...
      <CardBody>This is card.</CardBody>
      <CardFooter>
