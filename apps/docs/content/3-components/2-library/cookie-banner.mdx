...
libraries:
  - platform: 'local'
    link: '?path=/docs/typography-cookie-banner--docs'
    status: 'stable'
  - platform: 'global'
    link: '?path=/docs/typography-cookiebanner--docs'
    status: 'alpha'
  - platform: 'react'
    link: '?path=/docs/typography-cookiebanner--docs'
    status: 'alpha'
...
import { cookieBannerProps } from "@/components/document/cookie-banner/cookie-banner"
