...
libraries:
  - platform: 'figma'
    link: 'https://www.figma.com/design/ZEqfpXhocdZs1K5YfsE5ws/Design-system?node-id=4008-3141&t=x9tccZ94Zz8w2Tvu-4'
    status: 'alpha'
  - platform: 'global'
...
<Tabs id="tab1">
  ...
  <fieldset>
    ...
    <div class="gi-textarea-layout-container">
...
<Tabs id="tab2">
  ...
  ```html
  <fieldset class="">
    <label class="gi-text-md gi-label gi-mb-1" for="textarea-id-5">Label</label>
    <div class="gi-hint-text-md gi-hint-text gi-mb-1">Hint: This is a helpful hint.</div>
    <div class="gi-textarea-layout-container">
      <div class="gi-textarea-container" data-module="gieds-textarea">
        <textarea rows="4" cols="100" autocomplete="on" class="gi-textarea" maxlength="30" id="textarea-id-5" data-testid="textarea-id-5"></textarea>
      </div>
      <div class="gi-textarea-remaining-chars">
        <div class="gi-hint-text-md gi-hint-text">You have 30 characters remaining</div>
      </div>
    </div>
  </fieldset>
  ```
