  ...
  <TabPanel value="tab11">        
    ...
    <header id="GovieHeader" class="gi-header">
        ...
        <div id="MenuContainer" class="gi-header-menu">
            ...
            <label htmlFor="SearchTrigger" class="gi-header-tool-item">
            <input
            ...
            <label htmlFor="MobileMenuTrigger" class="gi-header-tool-item sm:gi-hidden">
            <input
                class="gi-block gi-w-0 gi-absolute gi-h-0"
        ...
        >
            ...
            <form action="/search_page">
                <label htmlFor="search" class="gi-text-md gi-font-bold gi-mb-4">
                Enter search term
                </label>
                <div class="gi-flex">
                <input
