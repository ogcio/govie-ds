...
import { HeadingAs } from '@govie-ds/react';
...
<div data-element="main-container" class="gi-py-5">
  ...
  ```html
  {{ govieCookieBanner({
    "children": govieHeading({"text": "Title", "tag": "h3"}) + govieParagraph({ "content": "We use some essential cookies to make this service work.<br><br>We’d also like to use analytics cookies so we can understand how you use the service and make improvements." }),
    "accept": {
      "children": govieHeading({"text": "Accepted Title", "tag": "h3"}) + govieParagraph({ "content": "You’ve accepted analytics cookies. You can change your cookie settings at any time." }),
      "triggerButton": {
        "content": "Accept cookies"
      }
    },
    "reject": {
      "children": govieHeading({"text": "Rejected Title", "tag": "h3"}) + govieParagraph({ "content": "You’ve rejected analytics cookies. You can change your cookie settings at any time." }),
      "triggerButton": {
