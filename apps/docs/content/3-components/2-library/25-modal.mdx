...
import { modalProps } from "@/components/navigation/modal"

<Modal triggerButton={modalProps.triggerButton}  >
{modalProps.children}
</Modal>
...
<div data-module="gieds-modal">
  ...
  <div data-testid="modal" data-element="modal" class="gi-modal gi-modal-close">
    <div
    ...
    >
      <span
        ...
        role="presentation"
        class="material-icons gi-block gi-text-[32px] gi-modal-icon"
      >
        close
      </span>
