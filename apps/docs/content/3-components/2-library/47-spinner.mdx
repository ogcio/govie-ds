...
import { modalSpinnerProps } from "@/components/navigation/modal"

<Modal triggerButton={modalSpinnerProps.triggerButton}  >
{modalSpinnerProps.children}
</Modal>
...
3. Placement and visibility:
    - Center the spinner within the loading area.
    - Ensure proper contrast against the background.
    - Add a slight delay (e.g. 100ms) before showing the spinner to avoid flickering for very fast loads.
4. Accessibility:
