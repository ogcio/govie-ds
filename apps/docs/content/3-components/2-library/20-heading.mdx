...
<Heading as={HeadingAs.h1}>This is an h1</Heading>
<Heading as={HeadingAs.h2}>This is an h2</Heading>
<Heading as={HeadingAs.h3}>This is an h3</Heading>
<Heading as={HeadingAs.h4}>This is an h4</Heading>
<Heading as={HeadingAs.h5}>This is an h5</Heading>
<Heading as={HeadingAs.h6}>This is an h6</Heading>
...
<Tabs id="tab1">
  ...
  <TabPanel value="tab12">        
    ```html
    {{ govieHeading({ "tag": "h1", "text": "This is an h1" }) }}
    {{ govieHeading({ "tag": "h2", "text": "This is an h2" }) }}
    {{ govieHeading({ "tag": "h3", "text": "This is an h3" }) }}
    {{ govieHeading({ "tag": "h4", "text": "This is an h4" }) }}
    {{ govieHeading({ "tag": "h5", "text": "This is an h5" }) }}
    {{ govieHeading({ "tag": "h6", "text": "This is an h6" }) }}
    ```
  </TabPanel>
...
<Tabs id="tab2">
  ...
  <TabPanel value="tab23">
    ...
    <Heading as={HeadingAs.h1} caption="This is a caption">This is a heading</Heading>
    ```
  </TabPanel>
</Tabs>
