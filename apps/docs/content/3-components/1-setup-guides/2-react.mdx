...
<Alert variant="danger" className="gi-max-w-none">
  **Deprecated** <br /> As of version 1.40.0, this component is no longer
  necessary and can be safely removed. Icons are now shipped directly from the
  package. If using Material Symbols font icons are necessary, follow the
  [Enabling Material Symbols
  story](/storybook-react/?path=/docs/components-icon--docs#enabling-material-symbols).
</Alert>
