...
In cases where material symbols font library is necessary, you can place this import line within your stylesheet. To use it with `<Icon/>` you must include the prop `useFontIcon`.
