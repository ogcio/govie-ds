...
<Blockquote>
  **Note:** The `LoadMaterialSymbols` component is a workaround solution to
  loads Material Symbols icons only in Next 16. It does NOT load the Lato font,
  you must load fonts using `next/font/google` as shown above.
</Blockquote>
