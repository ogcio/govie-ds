...
import { HeadingSize } from '@govie-ds/react';
...
<HeadingResponsiveSizes size={HeadingSize.xl} sampleText="Heading" />

#### Heading lg

Used for major sections within a page.

<HeadingResponsiveSizes size={HeadingSize.lg} sampleText="Heading" />

#### Heading md

For section headings.

<HeadingResponsiveSizes size={HeadingSize.md} sampleText="Heading" />

#### Heading sm

Used for subsections within a section of content.

<HeadingResponsiveSizes size={HeadingSize.sm} sampleText="Heading" />

#### Heading xs

For lower importance, and to be paired with body text of the same size.

<HeadingResponsiveSizes size={HeadingSize.xs} sampleText="Heading" />

#### Heading 2xs

For lower importance, and to be paired with body text of the same size.

<HeadingResponsiveSizes size={HeadingSize['2xs']} sampleText="Heading" />
