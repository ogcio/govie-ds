...
The largest text style in the scale. Use it rarely - for short labels or highlights where you need strong emphasis without switching to a heading.

<TextResponsiveSizes size="xl" sampleText="Text" />
