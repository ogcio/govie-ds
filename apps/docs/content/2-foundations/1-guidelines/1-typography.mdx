...
Used only once within a page, for either a main page heading or a major section within a page.

<HeadingResponsiveSizes size="xl" sampleText="Heading xl" />

### Heading large

For page heading, or major section headings.

<HeadingResponsiveSizes size="lg" sampleText="Heading lg" />

### Heading medium

Used for subsections within a section of content.

<HeadingResponsiveSizes size="md" sampleText="Heading md" />

### Heading small

For lower importance, and to be paired with body text of the same size.

<HeadingResponsiveSizes size="sm" sampleText="Heading sm" />

### Heading extra small

For lower importance, and to be paired with body text of the same size.

<HeadingResponsiveSizes size="xs" sampleText="Heading xs" />
...
<TextResponsiveSizes size="lg" sampleText="Text lg" />
...
<TextResponsiveSizes size="md" sampleText="Text md" />
...
<TextResponsiveSizes size="sm" sampleText="Text sm" />
