        ...
        <div class="gi-header-menu">
          <div class="gi-flex gi-items-center">
            <div class="gi-header-logo">
              <a href="/path" aria-label="Go to the home page"> Logo </a>
            </div>
            ...
            <div class="gi-flex gi-flex-col gi-gap-7">
              <div class="gi-flex sm:gi-gap-5 gi-items-end">
                <div class="grow gi-gap-4 gi-flex gi-flex-col">
                  ...
                  <div class="gi-input-text-container">
                    <div class="gi-input-text-container {{ marginTop }}">
                      <input
                        id="search-input"
                        type="text"
                        autocomplete="on"
          ...
          >
            <div role="group" aria-label="Organisations dropdown">
              <div data-module="gieds-dropdown-item">
                <button class="gi-combobox-toggle">
                ...
                >
                  <div class="gi-combobox-search">
                    <div
                      class="gi-input-text-container gi-combobox-search-input"
                    >
                      <div class="gi-input-text-container {{ marginTop }}">
                        <input
                          id="input-id"
                  ...
                  <div class="gi-combobox-checkbox-container">
                    ...
                    <div
                      class="gi-input-checkbox-container gi-combobox-checkbox"
                    >
                      <input
                        ...
                        class="gi-w-6 gi-h-6 checked:before:gi-w-3.5 checked:before:gi-h-2 checked:before:gi-left-0.5 checked:before:gi-top-1 gi-input-checkbox"
                        type="checkbox"
                      />
        ...
        <div class="my-6 gi-col-span-2 gi-col-start-2 gi-order-3">
          ...
          >
            ...
            >
              ...
              <span class="material-symbols-outlined gi-gray-700"
                >more_horiz</span
              >
