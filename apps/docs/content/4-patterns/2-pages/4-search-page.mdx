...
<Tabs id='tab1'>
  <TabList>
    <TabItem value='tab11'>HTML (global)</TabItem>
    <TabItem value='tab12'>HTML (local)</TabItem>
  </TabList>
 
  <TabPanel value='tab11'>
    <Tabs id='tab_macro'>
      <TabList>
        <TabItem value='tab_macro_1'>search-page.jinja</TabItem>
        <TabItem value='tab_macro_2'>vars.jinja</TabItem>
      </TabList>
      <TabPanel value='tab_macro_1'>
      ```html
    ...
    <div id="HeaderContainer" class="gi-layout-container">
      <div class="gi-header-menu">
        ...
        <div class="gi-header-logo">
          <a href="/path" aria-label="Go to the home page" data-testid="logo-link">
            <svg
              width="26" height="40" class="gi-stroke-none" viewBox="0 0 56 88" fill="none"
      ...
      <div class="gi-flex gi-items-center">
        <ul class="gi-header-nav">
          <li>
            <a data-testid="nav-link-desktop-1" href="#" aria-label="Link 1">Link 1</a>
          </li>
          <li>
            <a data-testid="nav-link-desktop-2" href="#" aria-label="Link 1">Link 2</a>
          </li>
          <li>
            <a data-testid="nav-link-desktop-3" href="#" aria-label="Link 3">Link 3</a>
          </li>
        </ul>
        ...
        <div class="gi-flex">
          <div class="gi-hidden sm:gi-flex">
            <label for="SearchTrigger" class="gi-header-tool-item">
              <input class="gi-header-mobile-menu-trigger" id="SearchTrigger" data-testid="SearchTrigger"
                type="checkbox">
                <span class="label">Search</span>
              <span data-testid="govie-icon" role="presentation" style="
            ...
            <label for="MobileMenuTrigger" class="gi-header-tool-item lg:gi-hidden">
              <input id="MobileMenuTrigger" class="gi-header-mobile-menu-trigger" type="checkbox" data-testid="header-mobile-menu" />
              ...
              font-variation-settings:
                ...
                'GRAD' 0,
                'opsz' 24;
            " class="material-symbols-outlined gi-block gi-text-[24px]">menu</span>
            </label>
        </div>
