...
#### Container Layout Limited to XL

Similar to `gi-container` class but limited to a max-width of 1280px.

<pre>.gi-layout-container-max-xl</pre>
...
<html lang="en">
  ...
  <body>
    ...
    <main class="gi-prose gi-max-w-none gi-layout-container-max-xl">
      <div class="gi-12-column-responsive-grid">
