...
The markup will likely be similar in structure, but with design modernisations, and will use different class names and data attribute names. Therefore when switching from local to global components, you will need to update the HTML markup.
