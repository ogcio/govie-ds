...
[Web Components](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) is a suite of technologies that provide a standard component model for the web, with wide browser support. Users can define new HTML tags that encapsulate appearance and behaviour.
